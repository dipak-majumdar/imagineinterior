                ...
                <div class="screen-body">
                    <div class="screen-body-item left">
                        ...
                        <div class="contact-dtls">
                            ...
                            <div class="app-contact mt-3"><a
                                    href="tel:<?php echo $site['contact1'];?>"><?php echo $site['contact1'];?></a></div>
                            <div class="app-contact"><a
                                    href="mailto:<?php echo $site['email'];?>"><?php echo $site['email'];?></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <?php
                        ...
                        ?>
                        <div class="app-form">
                            <form action="ajax/contact-form-submit.ajax.php" method="POST" onsubmit="return validateForm()"
                                name="contactForm">

                                <div class="app-form-group">
                                    <input class="app-form-control contact-input" name="name" id="name"
                                        placeholder="NAME">
                                    <span class="text-danger d-none">Please Enter Full Name.</span>
                                </div>

                                <div class="app-form-group">
                                    <input class="app-form-control contact-input" name="email" id="email"
                                        placeholder="EMAIL">
                                    <span class="text-danger d-none">Please Enter Email Address.</span>
                                </div>

                                <div class="app-form-group">
                                    <input class="app-form-control contact-input" name="contact-no" id="contact-no"
                                        placeholder="CONTACT NO">
                                    <span class="text-danger d-none">Please Enter Correct Number.</span>
                                </div>

                                <div class="app-form-group message">
                                    <input class="app-form-control contact-input" name="msg" id="msg"
                                        placeholder="MESSAGE">
