...
$activeChildServices   = $Services->activeChildServices();
$projectLimit   = $Projects->projectsByLimit(5);
            ...
            <div class="row">
                    ...
                    <div class="row">
                            ...
                            <div class="card info-card sales-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ps-3">
                                            <h6><?php echo count($activeServices)?></h6>
                                            <span
                                                class="text-success small pt-1 fw-bold"><?php echo count($allServices);?></span>
                        ...
                        <div class="col-xxl-4 col-md-6">
                            <div class="card info-card revenue-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Child Services <span>| Active</span></h5>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ps-3">
                                            <h6><?php echo count($activeChildServices);?></h6>
                                            <span
                                                class="text-success small pt-1 fw-bold"><?php echo count($allChildServices);?></span>
                                            <span class="text-muted small pt-2 ps-1">Total Child Services</span>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Recent Projects <span>| Last 6</span></h5>

                            <div class="activity">
                                <?php
                                foreach ($projectLimit as $eachProject) {
                                    echo '
                                        <div class="activity-item d-flex">
                                            <div class="activite-label">'.$DateUtil->shortTextDate($eachProject['added_on']).'</div>
